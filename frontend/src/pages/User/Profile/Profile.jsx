...
const Profile = () => {
  ...
  return (
    <div className='h-full min-h-screen'>
      <Header />
      <div className='w-full px-4 sm:px-8 md:px-12 lg:px-40 py-7 mt-16 flex flex-col space-y-4 md:flex-row'>
        <ProfileDetails isOwnProfile={true} userId={userId}/>
        <div className='bg-white shadow-equel h-full min-h-[80vh] sm:w-full md:w-3/4 lg:w-8/12 sm:mt-3 md:mt-0 md:ml-4 rounded-xl p-3'>
