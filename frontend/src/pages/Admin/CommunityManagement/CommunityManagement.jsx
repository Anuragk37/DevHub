  ...
  return (
    <div>
      ...
      <div className="flex flex-col min-h-full sm:mx-5 md:ml-64 mt-8 px-4">
        <h2 className="text-3xl font-bold text-gray-800 mb-6">Community Management</h2>
              ...
              <table className="w-full table-auto">
                ...
                <tbody className="bg-white">
                  {communities.map((community, index) => (
                    <tr key={community.id} className="border-b border-gray-200 hover:bg-gray-50 transition duration-150 ease-in-out">
                        ...
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10">
                            <img
                              ...
                              src={community.profile_pic_url || 'https://via.placeholder.com/40'}
                              alt={community.name}
                              onClick={() => setModalImage(community.profile_pic_url)}
                            />
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-4 text-sm text-gray-500">
                        {new Date(community.created_date).toLocaleDateString()}
                      </td>
                      <td className="px-4 py-4 text-sm text-gray-500">
